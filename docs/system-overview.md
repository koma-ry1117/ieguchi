...
```
1. 【来店挨拶】
   イエグチ: 「いらっしゃいませ。イエグチと申します」

2. 【ニーズ確認】
   イエグチ: 「本日はどのような物件をお探しでしょうか?」
...
イエグチ: 「承知しました。文京区で2LDK、家賃15万円以内ですね。
         他にご希望の条件はございますか？
         （駅からの距離、築年数、設備など）」
```
...
```
顧客: 「いい物件ないかな...」
イエグチ: 「かしこまりました。まずはいくつか確認させてください。
